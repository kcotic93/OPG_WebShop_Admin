...
public class CancelOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdialog = new ProgressDialog(CancelOrders.this);
        mdialog.setMessage(getResources().getString(R.string.wait));

        final Query queries = order_request.orderByChild("status").equalTo("3");
    ...
    private void loadOrders() {
        ...
        adapter = new FirebaseRecyclerAdapter<OrderRequest, OrderHolder>(OrderRequest.class, R.layout.order_item, OrderHolder.class, order_request.orderByChild("status").equalTo("3")) {
            ...
            protected void populateViewHolder(final OrderHolder viewHolder, OrderRequest ord, final int position) {
                ...
                viewHolder.order_status.setText(R.string.order_cancel);
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent order_detail = new Intent(CancelOrders.this,OrderDetail.class);
                        order_detail.putExtra("OrderId",adapter.getRef(position).getKey());
                        order_detail.putExtra("status","3");
