...
public class NewOrders extends Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.new_ordersActivity);
        ...
        mdialog = new ProgressDialog(NewOrders.this);
        mdialog.setMessage(getResources().getString(R.string.wait));

        final Query queries = order_request.orderByChild("status").equalTo("0");
    ...
    private void loadOrders() {
        ...
        adapter = new FirebaseRecyclerAdapter<OrderRequest, OrderHolder>(OrderRequest.class, R.layout.order_item, OrderHolder.class, order_request.orderByChild("status").equalTo("0")) {
            ...
            protected void populateViewHolder(final OrderHolder viewHolder, OrderRequest ord, final int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent order_detail = new Intent(NewOrders.this,OrderDetail.class);
                        order_detail.putExtra("OrderId",adapter.getRef(position).getKey());
                        order_detail.putExtra("status","0");
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_update:
                        ...
                        Pdf po=new Pdf(current,pos);
                        try {
                            po.cretaepdf(getApplicationContext());
                        } catch (IOException e) {
                            e.printStackTrace();
                        } catch (DocumentException e) {
                            e.printStackTrace();
                        }
                        Toast.makeText(NewOrders.this, R.string.status_updated, Toast.LENGTH_SHORT).show();
        ...
        tokens.orderByKey().equalTo(current.getUserUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapShot : dataSnapshot.getChildren()) {
                    ...
                    datasend.put("message",getResources().getString(R.string.your_order)+ " " +key+ " " +getResources().getString(R.string.updated_status)+" "+getResources().getString(R.string.received));
                    ...
                    mservice.sendNotification(dataMessage).enqueue(new Callback<MyResponse>() {
                        ...
                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                            ...
                            {
                                Toast.makeText(NewOrders.this, R.string.order_updated, Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                Toast.makeText(NewOrders.this, R.string.order_notification_failed, Toast.LENGTH_SHORT).show();
                            }
                        }
